...
import cn.huizhang43.pro.aitest.graph.model.Form13;
...
public class ManagerController {
    ...
    public List<Form13> readForm13List() {
        ...
        EasyExcel.read(new File("D:\\develop\\workspace\\workspace-ai\\sec-edgar-notebooks-main\\data\\sample\\form13.csv"), Form13.class, syncReadListener)
                .sheet()
                .doRead();
