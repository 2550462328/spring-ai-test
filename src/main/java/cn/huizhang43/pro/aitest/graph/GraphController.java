package cn.huizhang43.pro.aitest.graph;

import cn.huizhang43.pro.aitest.base.BusinessException;
import cn.huizhang43.pro.aitest.graph.chunk.ChunkController;
...
public class GraphController {
    ...
    public String chunkRag(@RequestParam String query) {
        List<Double> embed = ChunkController.floatsToDoubles(dashScopeEmbeddingModel.embed(query));
        ...
        return dashScopeChatModel.call(new UserMessage(content + "\n" + query));
    }
