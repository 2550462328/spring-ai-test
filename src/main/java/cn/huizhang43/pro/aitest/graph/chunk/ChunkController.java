...
public class ChunkController {
    ...
    public void createNodes() {
        var fileDir = new File("D:\\develop\\workspace\\workspace-ai\\sec-edgar-notebooks-main\\data\\sample\\form10k");
    ...
    public void createEmbedding() {
        ...
        int dimension = dashScopeEmbeddingModel.embed("你好").length;
        ...
        waitToEmbedList.forEach(chunk -> chunk.setTextEmbedding(floatsToDoubles(dashScopeEmbeddingModel.embed(chunk.getText()))));
